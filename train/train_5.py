...
checkpoint = "/cluster/scratch/yizchen/object/weight/sam2.1_hiera_large.pt"
...
res_dir = os.path.join(res_dir, 'exp_5', str(datetime.datetime.now()).replace(' ', '_').split('.')[0].replace(':', '_'))
